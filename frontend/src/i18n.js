...
const messages = {
  en: {
    message: {
      ...
      letterRuleEnding: "Right-align the signature and date",
      letterEndingDetected: "A signature and date were detected at the end.",
      letterSignature: "Signature",
      letterSignaturePlaceholder: "For example: Zhang San",
      letterSignatureHelp:
        "One or two lines are supported. Existing endings are filled in automatically when detected.",
      letterDate: "Date",
      letterDatePlaceholder: "For example: July 26, 2026",
  ...
  cn: {
    message: {
      ...
      letterRuleEnding: "署名和日期自动靠右",
      letterEndingDetected: "已识别并提取末尾的署名和日期。",
      letterSignature: "署名",
      letterSignaturePlaceholder: "例如：张三",
      letterSignatureHelp: "支持一到两行；若正文末尾已存在，会自动识别并填入。",
      letterDate: "日期",
